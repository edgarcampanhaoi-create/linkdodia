...
numeros:
  ...
  - id: "conta-agregadora-criterio"
    valor: "10 em 30 dias"
    titulo: "O limite da política de contas agregadoras do Instagram"
    curto: "limite do Instagram"
    oQueE: "Dez ou mais repostagens em 30 dias tiram a conta das recomendações para quem ainda não segue. É contagem em janela móvel, e não proporção. A conta volta quando cai abaixo de dez, e o status da conta no aplicativo mostra a situação, com opção de apelar."
    oQueFazer: "Abra o status da conta e veja a sua situação, em vez de adivinhar. Depois conte as repostagens dos últimos 30 dias, não a proporção: o número que decide é a contagem."
    categoria: "Algoritmo"
    confianca: "verificado"
    fonte: "Instagram for Creators, sobre recomendações e originalidade"
